...
type Draft = { title: string; due_date: string; due_time: string; priority: Priority; category: string; notes: string };
const emptyDraft = (): Draft => ({ title: "", due_date: todayISO(), due_time: "", priority: "medium", category: "", notes: "" });
